...
while True:
    ...
    if(ship_X == asteroid_y and asteroid_y == 3): #Test to see if the ship has hit an asteroid
        # STEP 1 ##########################################################
    ...
    if (ship_X != asteroid_y and asteroid_y == 3):   #Test to see if the current asteroid is at the bottom
        # STEP 2 ###########################################################
        # Write a logical expression (replace the "False") above to determine
